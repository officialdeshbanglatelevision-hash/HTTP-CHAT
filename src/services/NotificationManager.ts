import { requestAndRegisterFCMToken, removeFCMTokenOnLogout, initForegroundMessaging, checkSecureContext, getDeviceId } from '../services/fcmService';
...
export class NotificationManager {
  ...
  public async initializeForUser(uid: string): Promise<void> {
    ...
    // Check if notifications were previously enabled or permission is already granted
